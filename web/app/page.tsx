                        ...
                        >
                          <td className="px-6 py-4">
                            <div className="flex items-center gap-4">
                              ...
                              <span className="font-bold text-sm text-gray-900 dark:text-white line-clamp-1 group-hover:text-orange-500 transition-colors">{product.name}</span>
                            </div>
                          </td>
                          <td className="px-6 py-4">
                            <span className="text-[10px] font-black text-orange-600 bg-orange-50 dark:bg-orange-900/20 px-2 py-1 rounded-lg uppercase">{product.brand}</span>
                          </td>
                          <td className="px-6 py-4">
                          ...
                          <td className="px-6 py-4 text-right">
                            <div className="flex items-center justify-end gap-2">
                               ...
                               <button 
                                 onClick={(e) => { e.stopPropagation(); addToCartAction(product); }}
