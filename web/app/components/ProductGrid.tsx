      ...
      <div>
        <div className="aspect-square bg-[#F8F9FA] dark:bg-gray-800 rounded-xl mb-3 flex items-center justify-center overflow-hidden relative p-4">
          ...
          <button
            ...
            className={`absolute top-2 right-2 p-1.5 rounded-full backdrop-blur shadow-sm transition-all border ${isInCompare ? 'bg-orange-500 text-white border-orange-500' : 'bg-white/80 dark:bg-gray-700/80 text-gray-400 border-white hover:text-orange-500'}`}
