  ...
  if (userRole === 'public') {
    return (
      <div className="bg-white dark:bg-gray-900 border-t border-gray-100 dark:border-gray-850 px-5 py-4 shrink-0 space-y-4">
        <div className="space-y-2 py-3 text-center bg-gray-50 dark:bg-gray-800/40 p-4 rounded-xl border border-gray-100 dark:border-gray-800">
          <p className="text-xs font-black text-orange-500 uppercase tracking-widest">
            Pricing Hidden
          </p>
          <p className="text-[10px] text-gray-500 font-bold">
            Sign in as Reseller or Team to view pricing details and final estimates.
          </p>
        </div>
        <button
