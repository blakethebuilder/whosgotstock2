          ...
          {userRole === 'public' ? (
            ...
            <>
              ...
              <span className="text-[10px] font-bold text-orange-500">
                R {priceDisplay.incVat} <span className="text-[8px] text-gray-400 font-medium">Inc.</span>
              </span>
            </>
          )}
        </div>
      ...
      <td className="px-6 py-4 text-right">
        <div className="flex items-center justify-end gap-2">
          <button
            ...
            className={`p-2 rounded-xl transition-all ${isInCompare ? 'bg-orange-500 text-white border-orange-500' : 'bg-gray-50 dark:bg-gray-800 text-gray-400 hover:text-orange-500'}`}
