                                        ...
                                        {products.map(product => {
                                            ...
                                            switch (attr.key) {
                                                ...
                                                case 'description':
                                                    ...
                                                    break;
                                                case 'supplier_name':
                                                    content = <span className="px-2 py-1 bg-gray-100 dark:bg-gray-800 rounded-lg text-[9px] font-black uppercase text-gray-500">{(userRole === 'public' || userRole === 'team') ? 'Smart Integrate' : product.supplier_name}</span>;
                                                    break;
                                                default:
